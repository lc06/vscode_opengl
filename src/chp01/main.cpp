...
int main()
{
    ...
    Shader ourShader("D:/{Code}/Code Repository/vscode_c++/openglcmake/resources/texture.vs",
                     "D:/{Code}/Code Repository/vscode_c++/openglcmake/resources/texture.fs");
...
void mouse_callback(GLFWwindow *window, double xpos, double ypos)
{
    ...
    float yoffset = lastY - ypos; // xpos由窗口自左往右递增，而ypos由窗口自上往下递增，与OpenGL坐标系的Y坐标方向相反
